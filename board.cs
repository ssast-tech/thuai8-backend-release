...
namespace Server
{
    public struct Cell
    {
        public int state { get; set; } //  1: 可行走, 2: 占据, -1: 禁止
    ...
    class Board
    {
        ...
        public Cell[,] grid { get; private set; }//1: 可行走, 2: 占据, -1: 禁止 
        ...
        public int[,] validTarget(Piece p, float movement)// 接受参数棋子和行动力，返回该棋子的mask图，-1表示不可达，其他数字为到达该点的移动力消耗
        {
            //返回一张mask图，以01标记所有能抵达的点
